      ...
      <div className="footer-content">
        <div className="footer-content-column">
          <div className="footer-logo">
            <a className="footer-logo-link" href="#">
              <span className="hidden-link-text">Pooja Nahelia</span>
        ...
        <div className="footer-content-column">
          ...
          <div className="footer-call-to-action">
            ...
            <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="tel:01856838251" target="_self"> 01856838251 </a></p>
          </div>
        </div>
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a className="footer-copyright-link" href="https://ittareq.netlify.app/" target="_self"> ©2020. | Md Tariqul Islam. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
